 ...
 */
const STROKES = {
  line: { stroke: 'rgba(56,93,122,0.55)', width: 1.6 },
  faint: { stroke: 'rgba(56,93,122,0.22)', width: 1.2 },
  accent: { stroke: 'rgba(160,114,32,0.85)', width: 2 },
  accentSoft: { stroke: 'rgba(92,131,166,0.7)', width: 1.6 },
} as const;
        ...
        >
          <defs>
            <pattern id={`${uid}-fine`} width="24" height="24" patternUnits="userSpaceOnUse">
              <path d="M24 0H0V24" fill="none" stroke="rgba(56,93,122,0.09)" strokeWidth="1" />
            </pattern>
            <pattern id={`${uid}-coarse`} width="120" height="120" patternUnits="userSpaceOnUse">
              <path d="M120 0H0V120" fill="none" stroke="rgba(56,93,122,0.16)" strokeWidth="1" />
            </pattern>
          ...
          <g clipPath={`url(#${uid}-clip)`}>
            ...
            <g className="tv-frame" stroke="rgba(160,114,32,0.6)" strokeWidth="1.2" fill="none">
              <path
            ...
            {centre && spec.connect !== false ? (
              <>
                <g className="tv-links" fill="none" strokeWidth="1.3" stroke="rgba(56,93,122,0.32)">
              ...
              {spec.nodes.map((node, index) => (
                ...
                >
                  <circle
                    ...
                    stroke="rgba(56,93,122,0.35)"
                    strokeWidth="1.2"
                  />
                  <circle cx={node.x} cy={node.y} r="6" fill="rgba(56,93,122,0.9)" />
                  <circle
            ...
            {spec.measurement ? (
              <>
                <g className="tv-dims" stroke="rgba(160,114,32,0.8)" strokeWidth="1.2" fill="none">
                  <path
